      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="flex flex-col-reverse lg:flex-row gap-6 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Hola, soy <span className="text-white font-semibold">Alonso</span>, Ingeniero de Sistemas y desarrollador web con
                ...
                {[0, 120, 240].map((rotation, i) => (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 20px ${i === 0 ? '#a855f7' : i === 1 ? '#ec4899' : '#3b82f6'}`,
                      transformOrigin: `0 ${i === 0 ? '-180px' : i === 1 ? '-200px' : '-160px'}`,
                    }}
                    animate={{
                      rotate: 360,
                    }}
