...
const Contact = () => {
  ...
  return (
    <Section id="contacto" className="min-h-screen h-screen py-20 px-6 bg-linear-to-br from-gray-900 via-black to-gray-900 flex items-center relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              Estoy disponible para proyectos freelance y oportunidades interesantes.
            </motion.p>
...
//   const socials = [
//     { name: 'GitHub', url: 'https://github.com/alonsonh96' , icon: <FaGithubSquare />},
//     { name: 'LinkedIn', url: 'https://www.linkedin.com/in/alonso-nh/', icon: <FaLinkedin /> },
//     { name: 'Email', url: 'mailto:nichohuaman16@gmail.com' , icon: <ImMail4 /> },
//   ]
